  ...
  return (
    <section className="home-hero">
      <div
        ...
        style={{ backgroundImage: "url('/images/home/Apartment-Kelowna-Painting-Building-ConstructionPainting-Crestline-Painting.jpg')" }}
      />
      <div className="home-hero__overlay" />

      <div className="container">
        <div className="home-hero__content">
          <div className="home-hero__eyebrow">Commercial • Multifamily • Strata • Custom Homes</div>
