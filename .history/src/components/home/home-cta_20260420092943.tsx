        ...
        <div className="cta-panel">
          <div className="cta-panel__content">
            ...
            <p className="section-intro__copy">
              Crestline Painting works across British Columbia on commercial, multi-family,
              strata, custom home, and interior projects with a practical, organized approach
              built to deliver strong finishes and dependable execution.
            </p>
          </div>
