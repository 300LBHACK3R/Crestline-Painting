...
const serviceDetails: ServiceDetail[] = [
  {
    ...
    sidePanel: [
      {
        label: "Best For",
        value: "Homes, offices, occupied spaces, custom interiors, and detailed finish work.",
      },
      {
        label: "Project Focus",
        value: "Preparation, clean lines, surface protection, and consistent finish quality.",
      },
      {
        label: "Delivery Standard",
        value: "Organized, respectful, and built around a clean professional result.",
      },
    ],
  },
  {
    ...
    sidePanel: [
      {
        label: "Best For",
        value: "Apartments, townhomes, condominiums, and multi-residential developments.",
      },
      {
        label: "Project Focus",
        value: "Coordination, production workflow, consistency, and finish quality.",
      },
      {
        label: "Delivery Standard",
        value: "Structured execution for active, occupied, or staged project environments.",
      },
    ],
  },
  {
    ...
    sidePanel: [
      {
        label: "Best For",
        value: "Custom homes, luxury interiors, detailed repaints, and premium residential projects.",
      },
      {
        label: "Project Focus",
        value: "Craftsmanship, detail, surface preparation, and refined presentation.",
      },
      {
        label: "Delivery Standard",
  ...
  },
  {
    ...
    sidePanel: [
      {
        label: "Best For",
        value: "Offices, retail spaces, tenant improvements, institutions, and commercial buildings.",
      },
      {
        label: "Project Focus",
        value: "Durability, scheduling, professional appearance, and clean execution.",
      },
      {
        label: "Delivery Standard",
        value: "Organized commercial workflow with dependable communication and finish quality.",
      },
    ],
  },
  {
    ...
    sidePanel: [
      {
        label: "Best For",
        value: "Strata properties, occupied buildings, shared spaces, and building maintenance projects.",
      },
      {
        label: "Project Focus",
        value: "Property presentation, surface protection, coordination, and resident-aware execution.",
      },
      {
        label: "Delivery Standard",
        value: "Professional, organized, and respectful of active building environments.",
      },
    ],
  },
];
...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      images: [
        {
          url: service.detailImage || service.image,
          width: 1200,
          height: 630,
          alt: service.title,
        },
                ...
                <div>
                  <div className="section-intro section-intro--services">
                    ...
                    <p className="section-intro__copy">
                      Every service area is approached with a practical workflow:
                      understand the project environment, prepare surfaces
                      properly, protect surrounding areas, communicate clearly,
                      and deliver a clean professional finish.
                    </p>
                  </div>
