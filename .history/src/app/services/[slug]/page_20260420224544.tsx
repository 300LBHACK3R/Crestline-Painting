            ...
            <div className="service-detail-shell">
              <div className="service-detail-hero">
                <div className="service-detail-hero__content">
                  <div className="section-intro__eyebrow">Project Environments</div>
                ...
                <div className="split-panel__content service-detail__content">
                  ...
                  <div className="service-gallery">
                    {service.galleryImages.map((image, index) => (
                      <div key={`${service.slug}-${index}`} className="service-gallery__item">
                        <img
                          src={image}
                          alt={`${service.title} project view ${index + 1}`}
                ...
                <div className="service-side-panel">
                  <div className="service-side-panel__body">
                    ...
                    <div className="service-side-panel__item">
                      ...
                      <span>
                        Structured execution built around planning, coordination, and consistency.
                      </span>
                    </div>
                    ...
                    <div className="service-side-panel__item">
                      ...
                      <span>
                        Professional standards focused on clean delivery, quality control, and dependable outcomes.
                      </span>
                    </div>
                    ...
                    <div className="service-side-panel__item">
                      ...
                      <span>
                        From detailed custom work to larger production environments, Crestline delivers with control.
                      </span>
                    </div>
                    ...
                    <div className="service-side-panel__item">
                      ...
                      <span>
                        Preparation, finish consistency, and jobsite professionalism remain central at every stage.
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="service-proof-strip">
                <div className="service-proof-strip__item">
                  ...
                  <span>Clean systems, coordination, and dependable delivery from start to finish.</span>
                </div>
                <div className="service-proof-strip__item">
                  <strong>Consistent Quality</strong>
                  <span>Finish standards built around preparation, detail, and long-term presentation.</span>
                </div>
                <div className="service-proof-strip__item">
                  <strong>Project Confidence</strong>
                  <span>Built to support commercial, multi-family, strata, and custom environments across BC.</span>
                </div>
              </div>
            </div>
          </div>
