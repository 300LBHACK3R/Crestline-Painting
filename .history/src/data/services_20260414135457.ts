...
export const services: ServiceItem[] = [
  ...
  },
  {
    ...
    intro:
      "Our interior painting services are built around clean execution, proper preparation, and a professional finish that elevates the space. From occupied homes to business interiors, we focus on detail, protection, and a polished result.",
    bullets: [
