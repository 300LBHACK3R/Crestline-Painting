...
export default function HomeProjectsPreview() {
  const previewProjects = projects.slice(0, 6); // was 4

  return (
    <section className="section home-projects-preview">
      <div className="container">
        ...
        <div className="section-intro home-projects-preview__intro">
          ...
          <h2 className="section-intro__title">
            A portfolio built across commercial, multi-family, strata, and custom environments.
          </h2>

          <p className="section-intro__copy">
            Crestline Painting delivers practical, professional results across British Columbia,
        ...
        <div className="project-showcase-grid">
          {previewProjects.map((project) => (
            <Link
              ...
              aria-label={`View project portfolio: ${project.title}`}
            >
              <article>
                <div
