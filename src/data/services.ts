...
export const services = [
  {
    ...
    short:
      "Clean, detailed interior painting for residential, commercial, and occupied spaces.",
    intro:
      "Crestline Painting delivers interior painting with careful preparation, clean jobsite protection, and a professional finish built to elevate the space.",
    bullets: [
      "Walls, ceilings, doors, and trim",
      "Residential and commercial interiors",
      "Surface preparation, patching, and sanding",
      "Clean masking and jobsite protection",
      "Detailed finish work for polished interior spaces",
    ],
    image:
